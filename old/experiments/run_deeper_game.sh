...
# test: does a deeper game tree let TIPS's causal reach probs shine?
# max_turns=5, num_samples=1, 100 iterations
# with 5 rounds of offers, each player makes up to 3 decisions per path,
# giving causal reach-prob vectors ~15-20 elements deep
...
NUM_SAMPLES=1
SAMPLER="external"
RESULTS_DIR="./experiments/results_deeper_game"
...
echo "========================================"
echo "deeper game: turns=5, samples=1, iter=$ITERATIONS"
echo "========================================"
