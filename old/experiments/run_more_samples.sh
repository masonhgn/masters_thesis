...
# test: does increasing num_samples reduce noise enough to see TIPS win?
# max_turns=3, num_samples=10, 100 iterations
...
NUM_SAMPLES=10
SAMPLER="external"
RESULTS_DIR="./experiments/results_more_samples"
...
echo "========================================"
echo "more samples: turns=3, samples=10, iter=$ITERATIONS"
echo "========================================"
