...
# max_turns=4, num_samples=5, 100 iterations
# tests whether sampling noise is masking algorithm differences
...
NUM_SAMPLES=5
SAMPLER="external"
RESULTS_DIR="./experiments/results_4turns_5samples"
...
echo "========================================"
echo "4 turns + 5 samples: turns=4, samples=5, iter=$ITERATIONS"
echo "========================================"
