...
# test: both deeper game AND more samples — best chance for TIPS to win
# max_turns=5, num_samples=10, 100 iterations
...
NUM_SAMPLES=10
SAMPLER="external"
RESULTS_DIR="./experiments/results_deeper_more_samples"
...
echo "========================================"
echo "deeper + more samples: turns=5, samples=10, iter=$ITERATIONS"
echo "========================================"
