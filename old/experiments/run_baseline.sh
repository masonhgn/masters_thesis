...
# baseline experiment: max_turns=3, num_samples=1, 100 iterations
# this is the current setup that shows CSPS winning but TIPS tied with CFR
...
NUM_SAMPLES=1
SAMPLER="external"
RESULTS_DIR="./experiments/results_baseline"
...
echo "========================================"
echo "baseline: turns=3, samples=1, iter=$ITERATIONS"
echo "========================================"
